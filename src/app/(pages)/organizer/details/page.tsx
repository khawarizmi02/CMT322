...
const EventPage = () => {
  ...
  const eventDetails =
    eventType === 'badminton' ? badmintonEventDetails : volleyballEventDetails;
  const categories =
    eventType === 'badminton' ? badmintonCategories : volleyballCategories;
  const matches =
    eventType === 'badminton' ? badmintonMatches : volleyballMatches;
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex flex-col gap-2">
            <Button
              onClick={() =>
                setEventType(
                  eventType === 'badminton' ? 'volleyball' : 'badminton'
                )
              }
              variant="outline"
              className="gap-2"
      ...
      <div className="lg:w-1/3 p-6 space-y-6">
        <Card className="bg-gradient-to-br from-primary/5 to-primary/10">
          ...
          <CardContent>
            ...
            />
            <p className="text-muted-foreground mb-6">{eventDetails.about}</p>
