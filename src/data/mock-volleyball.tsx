...
export type VolleyballLeaderboardType = {
  id: string;
  team: string;
  desasiswa: string;
  win: number;
...
export const volleyballEventDetails = {
  title: 'Volleyball',
  about:
    "Volleyball events in SUKAD feature thrilling matches across men's, women's, and mixed categories. Games are held at the Indoor Stadium, highlighting the top teams from each Desasiswa.",
  previousChampion: 'Desasiswa Tekun',
  venue: 'Indoor Stadium',
  image:
    'https://images.unsplash.com/photo-1665406857477-e19222ca862c?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
};
